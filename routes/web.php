...
Route::get('/quen-mat-khau', [App\Http\Controllers\AuthController::class, 'showForgotForm'])->name('password.request');
Route::post('/quen-mat-khau', [App\Http\Controllers\AuthController::class, 'sendResetLink'])->name('password.email');
Route::get('/dat-lai-mat-khau/{token}', [App\Http\Controllers\AuthController::class, 'showResetForm'])->name('password.reset');
Route::post('/dat-lai-mat-khau', [App\Http\Controllers\AuthController::class, 'resetPassword'])->name('password.update');
...
Route::post('contact', [PageController::class, 'storeContract'])->name('contact.store');
...
Route::get('comment/delete/{id}/{idxe}', [CommentController::class, 'deleteComment'])->name('comment.delete');
// ADMIN ROUTE
...
Route::post('/momo', [App\Http\Controllers\MomoController::class, 'momoPayment'])->name('momo');
Route::get('/momo/success', [App\Http\Controllers\MomoController::class, 'momoSuccess'])->name('momo.success');
Route::post('/momo/ipn', [App\Http\Controllers\MomoController::class, 'momoIPN'])->name('momo.ipn');
