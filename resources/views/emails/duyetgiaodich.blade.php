...
<body>
    ...
    <section id="contact" style="width: 100%;">
        ...
        font-size: 30px;
        color: #002B3D;">Dịch vụ thuê xe SuperCar
            </h1>
        ...
        color: #fff;">
                <h3 style="font-size: 36px;"> <i class="ri-store-2-line"></i> SUPERCAR</h3>
            </div>
            ...
            <i>
                Mọi thông tin chi tiết liên hệ website: <a style="color: f6e58d;"
                    href="https://supercar.click/">supercar.click</a> hoặc liên hệ hotline <i
