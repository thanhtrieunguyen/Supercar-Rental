...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/chitietxe.css') }}">
@endpush
                    ...
                    <div class="detail-container">
                        ...
                        <div class="sidebar-detail">
                            <div class="rent-box" id="cardetail" style="position: relative;">
                                @if($xe->tinhtrang == 1)
                                <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5); z-index: 10; border-radius: 8px; display: flex; justify-content: center; align-items: center;">
                                    <div style="background-color: #f8d7da; color: #721c24; padding: 15px; border-radius: 8px; text-align: center; width: 80%;">
                                        <i class="fas fa-exclamation-circle" style="font-size: 24px;"></i>
                                        <h5 class="mt-2">Xe đã được đặt</h5>
                                        <p class="mb-0">Vui lòng chọn xe khác hoặc quay lại sau</p>
                                    </div>
                                </div>
                                @elseif($xe->tinhtrang == -1)
                                <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5); z-index: 10; border-radius: 8px; display: flex; justify-content: center; align-items: center;">
                                    <div style="background-color: #fff3cd; color: #856404; padding: 15px; border-radius: 8px; text-align: center; width: 80%;">
                                        <i class="fas fa-clock" style="font-size: 24px;"></i>
                                        <h5 class="mt-2">Xe đang chờ xác nhận</h5>
                                        <p class="mb-0">Vui lòng chọn xe khác hoặc quay lại sau</p>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="dropdown-form "><label>Địa điểm giao nhận xe</label>
                                    <div class="wrap-form has-arrow"><span class="value">SuperCar</span>
                                    </div>
                                </div>
                                ...
                                @elseif($xe->tinhtrang == 1)
                                <button class="btn btn-secondary btn--m width-100" disabled>
                                    <i class="fas fa-ban" style="font-size: 1rem !important;"></i>
                                    ĐÃ ĐƯỢC ĐẶT
                                </button>
                                @elseif($xe->tinhtrang == -1)
                                <button class="btn btn-warning btn--m width-100" disabled>
                                    <i class="fas fa-clock" style="font-size: 1rem !important;"></i>
                                    CHỜ XÁC NHẬN
                                </button>
                                @endif
                                @else
                                ...
                                <div class="cancel-policy">
                                    ...
                                    <div class="desc-note">
                                        ...
                                        <p class="df-align-center">* Tiền giữ chỗ &amp; bồi thường cho chủ xe hủy
                                            chuyến (nếu có) sẽ được SuperCar hoàn trả đến bạn bằng chuyển khoản ngân hàng
                                            trong vòng 1-3 ngày làm việc.<span class="tooltip tooltip--m "><span
                                                    class="wrap-svg"><svg width="24" height="24"
                                                        ...
                                                        đền cọc</b>SuperCar sẽ hoàn lại tiền cọc (&amp; tiền đền cọc do
                                                    chủ
                                                    ...
                                                    điểm hủy chuyến.<i>*Nhân viên SuperCar sẽ liên hệ khách thuê (qua số
                                                        điện thoại đã đăng ký trên SuperCar) để xin thông tin tài khoản
                                                        ngân hàng, hoặc Khách thuê có thể chủ động gửi thông tin cho
                                                        SuperCar qua email Contact@SuperCar.vn hoặc nhắn tin tại SuperCar
