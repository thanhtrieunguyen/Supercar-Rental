...
@section('content')
    <!-- Banner Section -->
    <div class="carousel-inner shadow border-0">
        <div class="carousel-item active banner__img " style="text-align: center;">
            <h1>SuperCar - Cùng Bạn Đến Mọi Hành Trình</h1><br>
                    ...
                    <div class="car-slide">
                        <div class="product-item">
                            <div class="product-top">
                                ...
                                <a href="{{ route('xe.show', ['id' => $xe->idxe]) }}" class="rent-now">Thuê Xe</a>
                            </div>
